...
am__append_27 = lib/stream-ssl.c
am__append_28 = lib/dhparams.c
#am__append_29 = lib/stream-nossl.c
#am__append_30 = ${PTHREAD_LIBS}
am__append_31 = \
...
am__append_32 = utilities/ovs-vlan-bug-workaround
am__append_33 = utilities/nlmon
...
am__append_37 = utilities/bugtool/ovs-bugtool.8.in
...
# are acceptable as C++.
#am__append_51 = include/openvswitch/libcxxtest.la
am__append_52 = vswitchd/vswitch.gv vswitchd/vswitch.pic
am__append_53 = vtep/vtep.gv vtep/vtep.pic
#am__append_54 = $(srcdir)/datapath-windows/include/OvsDpInterface.h
am__append_55 = ovn/ovn-sb.gv ovn/ovn-sb.pic
am__append_56 = ovn/ovn-nb.gv ovn/ovn-nb.pic
subdir = .
...
am__lib_libopenvswitch_la_SOURCES_DIST = lib/aes128.c lib/aes128.h \
	...
	lib/ovs-atomic-c++.h lib/ovs-atomic-c11.h \
	...
	lib/ovs-atomic.h lib/ovs-lldp.c lib/ovs-lldp.h lib/ovs-numa.c \
	lib/ovs-numa.h lib/ovs-rcu.c lib/ovs-rcu.h lib/ovs-router.h \
...
am_lib_libopenvswitch_la_OBJECTS = lib/aes128.lo lib/backtrace.lo \
	...
	lib/ovsdb-session.lo lib/ovsdb-types.lo lib/packets.lo \
...
nodist_lib_libopenvswitch_la_OBJECTS = lib/dirs.lo \
	lib/ovsdb-server-idl.lo lib/vswitch-idl.lo $(am__objects_13)
...
am__noinst_HEADERS_DIST = AUTHORS.rst CONTRIBUTING.rst MAINTAINERS.rst \
	...
	.travis/osx-prepare.sh appveyor.yml boot.sh lib/colors.man \
	lib/common.man lib/common-syn.man lib/coverage-unixctl.man \
	lib/daemon.man lib/daemon-syn.man lib/db-ctl-base.man \
	lib/dpctl.man lib/memory-unixctl.man \
	lib/netdev-dpdk-unixctl.man lib/ofp-version.man lib/ovs.tmac \
	...
	build-aux/extract-ofp-msgs lib/ovsdb-server-idl.ann \
	...
	tests/test-unixctl.py tests/test-vlog.py tests/uuidfilt.py \
	...
	build-aux/dpdkstrip.py build-aux/sodepends.py \
...
ACLOCAL = ${SHELL} /home/yangye/vhost-user/openvswitch-2.9.2/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AUTOCONF = ${SHELL} /home/yangye/vhost-user/openvswitch-2.9.2/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/yangye/vhost-user/openvswitch-2.9.2/build-aux/missing autoheader
AUTOM4TE = ${SHELL} /home/yangye/vhost-user/openvswitch-2.9.2/build-aux/missing autom4te
AUTOMAKE = ${SHELL} /home/yangye/vhost-user/openvswitch-2.9.2/build-aux/missing automake-1.15
AWK = gawk
CAPNG_LDADD = 
...
LDFLAGS = 
LIBOBJS = 
LIBS = -ldpdk -ldl -lnuma -latomic -lpthread -lrt -lm  -lnuma
...
LT_REVISION = 0
LT_SYS_LIBRARY_PATH = 
MAKEINFO = ${SHELL} /home/yangye/vhost-user/openvswitch-2.9.2/build-aux/missing makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
MSVC64_LDFLAGS = 
MSVC_CFLAGS = 
...
OTOOL = 
OTOOL64 = 
OVS_CFLAGS =  -I../dpdk-stable-17.11.9/x86_64-native-linuxapp-gcc/include
...
OVS_LDFLAGS =  -L../dpdk-stable-17.11.9/x86_64-native-linuxapp-gcc/lib
OVS_LTINFO = -release 2.9 -version-info 0:2
PACKAGE = openvswitch
PACKAGE_BUGREPORT = bugs@openvswitch.org
PACKAGE_NAME = openvswitch
PACKAGE_STRING = openvswitch 2.9.2
...
abs_builddir = /home/yangye/vhost-user/openvswitch-2.9.2
abs_srcdir = /home/yangye/vhost-user/openvswitch-2.9.2
abs_top_builddir = /home/yangye/vhost-user/openvswitch-2.9.2
abs_top_srcdir = /home/yangye/vhost-user/openvswitch-2.9.2
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/yangye/vhost-user/openvswitch-2.9.2/build-aux/install-sh
...
ALL_LOCAL = dist-hook-git config-h-check printf-check static-check \
	check-assert-h-usage check-endian check-echo-n \
	thread-safety-check check-ifconfig $(am__append_6) \
	$(am__append_8) $(am__append_9) $(am__append_11) \
	$(am__append_50) cxx-check check-debian-changelog-version \
...
CLEANFILES = all-distfiles all-gitfiles missing-distfiles distfiles \
	...
	utilities/ovs-vsctl.8 $(am__append_35) $(valgrind_wrappers) \
	$(am__append_46) include/odp-netlink.h $(am__append_49) \
	cxx-check debian/copyright vswitchd/ovs-vswitchd.8 \
	$(am__append_52) vswitchd/ovs-vswitchd.conf.db.5 \
	...
	vtep/vtep-ctl.8 vtep/ovs-vtep $(am__append_53) vtep/vtep.5 \
	vtep/vtep.ovsschema.stamp \
	$(srcdir)/datapath-windows/include/OvsDpInterface.h \
	$(am__append_55) ovn/ovn-sb.5 $(am__append_56) ovn/ovn-nb.5 \
...
EXTRA_DIST = AUTHORS.rst CONTRIBUTING.rst MAINTAINERS.rst README.rst \
	...
	.travis/linux-prepare.sh .travis/osx-build.sh \
	.travis/osx-prepare.sh appveyor.yml boot.sh $(MAN_FRAGMENTS) \
	...
	lib/table.xml lib/vlog.xml lib/vswitch-idl.ann \
	...
	$(CHECK_PYFILES) build-aux/extract-odp-netlink-h \
	build-aux/check-structs third-party/ofp-tcpdump.patch \
	third-party/README.rst debian/changelog debian/compat \
...
# Docker drivers
bin_SCRIPTS = utilities/ovs-docker utilities/ovs-pki $(am__append_31) \
	ovn/utilities/ovn-docker-overlay-driver \
	ovn/utilities/ovn-docker-underlay-driver \
	ovn/utilities/ovn-detrace
...
INSTALL_DATA_LOCAL = install-man-rst lib-install-data-local \
	$(am__append_40)
UNINSTALL_LOCAL = uninstall-man-rst $(am__append_41) \
	ovs-uninstall-local
# ovsdb-tool.1
# ovsdb-client.1
# ovsdb-server.1
man_MANS = lib/ovs-fields.7 utilities/ovs-appctl.8 utilities/ovs-ctl.8 \
	...
	$(am__append_36) vswitchd/ovs-vswitchd.8 \
...
MAN_ROOTS = utilities/ovs-appctl.8.in \
	...
	utilities/ovs-tcpundump.1.in \
	utilities/ovs-vlan-bug-workaround.8.in \
	utilities/ovs-vsctl.8.in $(am__append_37) \
	vswitchd/ovs-vswitchd.8.in ovsdb/ovsdb-tool.1.in \
	ovsdb/ovsdb-client.1.in ovsdb/ovsdb-server.1.in \
	ovsdb/ovsdb-idlc.1 vtep/vtep-ctl.8.in \
	ovn/utilities/ovn-sbctl.8.in ovn/utilities/ovn-detrace.1.in
...
lib_LTLIBRARIES = lib/libopenvswitch.la lib/libsflow.la \
	...
	ovn/lib/libovn.la
noinst_LTLIBRARIES = $(am__append_51)
...
FLAKE8_PYFILES = Documentation/conf.py ofproto/ipfix-gen-entities \
	...
	utilities/ovs-dev.py utilities/ovs-tcpdump.in $(am__append_39) \
	$(CHECK_PYFILES) \
	xenserver/usr_share_openvswitch_scripts_ovs-xapi-sync \
...
lib_libopenvswitch_la_SOURCES = lib/aes128.c lib/aes128.h \
	...
	$(am__append_29)
nodist_lib_libopenvswitch_la_SOURCES = lib/dirs.c \
	lib/ovsdb-server-idl.c lib/ovsdb-server-idl.h \
	lib/vswitch-idl.c lib/vswitch-idl.h $(am__append_28)
...
ofproto_libofproto_la_LIBADD = lib/libsflow.la $(am__append_30)
...
tests_ovstest_SOURCES = tests/ovstest.c tests/ovstest.h \
	...
	tests/test-stp.c tests/test-unixctl.c tests/test-util.c \
	tests/test-uuid.c tests/test-bitmap.c tests/test-vconn.c \
	tests/test-aa.c $(am__append_43) $(am__append_44)
